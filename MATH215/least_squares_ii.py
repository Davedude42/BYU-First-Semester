...
def row_func(t,n):
  ...
  for n in range(1, n+1):
    ret.append(np.cos(n*t))
    ret.append(np.sin(n*t))
  ret.insert(0, 1)
  return ret
...
def design_matrix(n):
  ...
  for t in range(len(T)):
    ret.append(row_func(T[t],n))
  return np.array(ret) # Put your return value here.
...
def f2(t):
  # Put your code here.
  return np.dot(np.array(row_func(t, 2)), beta2)
...
MSE2=1/629 * (np.linalg.norm(X2 @ beta2 - Y) ** 2)    # Replace the 0 value with the mean square error you compute in Problem 8.
...
beta10=np.linalg.solve(np.transpose(X10) @ X10, np.transpose(X10) @ Y)

MSE10=1/629 * (np.linalg.norm(X10 @ beta10 - Y) ** 2)

def f10(t):
  # Put your code here.
  return np.dot(np.array(row_func(t, 10)), beta10)
...
beta100=np.linalg.solve(np.transpose(X100) @ X100, np.transpose(X100) @ Y)

MSE100=1/629 * (np.linalg.norm(X100 @ beta100 - Y) ** 2)

def f100(t):
  # Put your code here.
  return np.dot(np.array(row_func(t, 100)), beta100)
...
beta1000=np.linalg.solve(np.transpose(X1000) @ X1000, np.transpose(X1000) @ Y)

MSE1000=1/629 * (np.linalg.norm(X1000 @ beta1000 - Y) ** 2)

def f1000(t):
  # Put your code here.
  return np.dot(np.array(row_func(t, 1000)), beta1000)
