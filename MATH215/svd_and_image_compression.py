...
def reconstructed_array(u,s,v_t):
  return u @ sigma(u.shape[1], v_t.shape[0], s) @ v_t
...
def lower_rank(A,k):
  ...
  return reconstructed_array(u_c, s_c, v_c)
...
original_size=gray_array.shape[0] * gray_array.shape[1]

"""**Problem 5**"""
"""
_1, s, _2 = np.linalg.svd(gray_array)
...
rank_100_size=gray_array.shape[0] * 100 + 100 + gray_array.shape[1] * 100
